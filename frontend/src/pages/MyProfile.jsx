...
export default function MyProfile() {
  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 p-2 text-sm'>
       ...
       <div>
         ...
         <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          <p className='font-medium'>Gender:</p>
           {
        isEdit
        ? <select className='max-w-20 bg-gray-100' onChange={(e)=>setUserData(prev=>({...prev,geneder:e.target.value}))} value={userData.geneder}>
